  ...
  <header class="site-header">
    <div class="site-header-inner">
      ...
      <div class="header-actions">
        <button @click="goDash" class="tr-btn hdr-btn-dash" style="border:1px solid #d9dbe0;background:#fff;color:#15294f;font-size:13.5px;font-weight:600;padding:9px 16px;border-radius:10px;cursor:pointer;display:flex;align-items:center;gap:7px;">
