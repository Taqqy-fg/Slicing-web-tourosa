  ...
  <section style="background:#13233f;color:#fff;">
    <div data-aos="zoom-in" style="max-width:1000px;margin:0 auto;padding:84px 32px;text-align:center;">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:14px;">
        <div style="width:52px;height:52px;display:block;;background:repeating-linear-gradient(45deg,#efece4,#efece4 9px,#e6e3d8 9px,#e6e3d8 18px);border:1px dashed #d4d0c2;display:flex;align-items:center;justify-content:center;border-radius:50%;overflow:hidden;"><span style="font-family:'IBM Plex Mono',monospace;font-size:10.5px;line-height:1.4;color:#a8a08c;text-align:center;padding:0 10px;">Foto</span></div>
