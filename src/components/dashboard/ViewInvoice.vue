      ...
      <div style="display:flex;justify-content:space-between;gap:40px;padding-top:24px;">
        <div style="flex:1;max-width:320px;">
          ...
          <div style="background:#fafbfc;border:1px solid #eef0f3;border-radius:10px;padding:13px 15px;">
            <div style="font-size:11px;font-weight:700;color:#9aa0ad;text-transform:uppercase;letter-spacing:.05em;margin-bottom:7px;">Pembayaran</div>
            <div style="font-size:12.5px;color:#13233f;line-height:1.7;">Bank Central Asia (BCA)<br>No. Rek <span style="font-family:'IBM Plex Mono',monospace;font-weight:700;">1234-567-890</span><br>a.n. PT Tourosa Travel</div>
          </div>
        </div>
        <div style="width:300px;flex-shrink:0;">
          <div style="display:flex;justify-content:space-between;padding:8px 0;"><span style="font-size:13px;color:#5d6a82;">Subtotal</span><span style="font-size:13px;font-weight:600;color:#13233f;font-family:'IBM Plex Mono',monospace;">{{ inv.subtotalF }}</span></div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;"><span style="font-size:13px;color:#5d6a82;">Diskon</span><span style="font-size:13px;font-weight:600;color:#c2603a;font-family:'IBM Plex Mono',monospace;">- {{ inv.discountF }}</span></div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;border-bottom:1px solid #eef0f3;"><span style="font-size:13px;color:#5d6a82;">Pajak / Service ({{ inv.taxPercentF }}%)</span><span style="font-size:13px;font-weight:600;color:#13233f;font-family:'IBM Plex Mono',monospace;">{{ inv.taxF }}</span></div>
          <div style="display:flex;justify-content:space-between;align-items:center;padding:14px 0;"><span style="font-size:15px;font-weight:800;color:#13233f;">TOTAL</span><span style="font-size:20px;font-weight:800;color:#13233f;font-family:'IBM Plex Mono',monospace;">{{ inv.totalF }}</span></div>
          <div style="background:#13233f;border-radius:11px;padding:14px 16px;">
            <div style="display:flex;justify-content:space-between;margin-bottom:9px;"><span style="font-size:12px;color:#9fabc4;">Per pax</span><span style="font-size:12.5px;font-weight:700;color:#fff;font-family:'IBM Plex Mono',monospace;">{{ inv.perPaxF }}</span></div>
            <div style="display:flex;justify-content:space-between;margin-bottom:9px;"><span style="font-size:12px;color:#9fabc4;">DP ({{ inv.dpPercentF }}%)</span><span style="font-size:12.5px;font-weight:700;color:#7ed3a6;font-family:'IBM Plex Mono',monospace;">{{ inv.dpF }}</span></div>
            <div style="display:flex;justify-content:space-between;padding-top:9px;border-top:1px solid #24365a;"><span style="font-size:12px;color:#9fabc4;">Sisa pelunasan</span><span style="font-size:12.5px;font-weight:700;color:#f0c98a;font-family:'IBM Plex Mono',monospace;">{{ inv.sisaF }}</span></div>
          </div>
        </div>
      </div>
      <!-- jadwal termin -->
