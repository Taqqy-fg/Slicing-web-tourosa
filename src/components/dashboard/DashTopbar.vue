...
<template>
  <header data-print="hide" style="background:#fff;border-bottom:1px solid #e8e9ee;padding:18px 32px;display:flex;align-items:center;justify-content:space-between;gap:20px;position:sticky;top:0;z-index:20;">
    <div>
