...
<template>
  <div v-if="detail" class="p-mobile" style="padding:30px 32px;max-width:1060px;margin:0 auto;">
    ...
    <div class="grid-cols-1-mobile" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:18px;">
    ...
    <div style="background:#fff;border:1px solid #e8e9ee;border-radius:16px;overflow:hidden;margin-bottom:18px;">
      ...
      <div class="table-scroll">
        <div class="min-w-table">
          <div class="table-header-mobile" style="display:grid;grid-template-columns:30px 1fr 46px 116px 116px 120px 116px;gap:10px;padding:11px 22px;background:#fafbfc;font-size:11px;font-weight:700;color:#9aa0ad;text-transform:uppercase;letter-spacing:.03em;">
          ...
          <div v-for="(it, idx) in detailItems" :key="idx" class="table-row-mobile" style="display:grid;grid-template-columns:30px 1fr 46px 116px 116px 120px 116px;gap:10px;padding:13px 22px;border-top:1px solid #f1f2f5;align-items:flex-start;">
            ...
            <span class="col-third-mobile text-right-mobile" style="font-size:13px;color:#5d6a82;text-align:center;font-family:'IBM Plex Mono',monospace;">Qty: {{ it.qtyF }}</span>
            <span class="col-third-mobile text-right-mobile" style="font-size:12.5px;color:#9aa0ad;text-align:right;font-family:'IBM Plex Mono',monospace;">B: {{ it.costF }}</span>
            <span class="col-third-mobile text-right-mobile" style="font-size:12.5px;color:#5d6a82;text-align:right;font-family:'IBM Plex Mono',monospace;">J: {{ it.priceF }}</span>
            <span class="col-half-mobile text-right-mobile" style="font-size:13px;font-weight:700;color:#13233f;text-align:right;font-family:'IBM Plex Mono',monospace;">Sub: {{ it.lineSellF }}</span>
            <span class="col-half-mobile text-right-mobile" :style="{ color: it.profitColor }" style="font-size:13px;font-weight:700;text-align:right;font-family:'IBM Plex Mono',monospace;">Pr: {{ it.lineProfitF }}</span>
          </div>
        </div>
      </div>
